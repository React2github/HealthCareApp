...
import IndividualSupport from "./IndividualSupportComponent/IndividualSupport";
...
const MainDemoForm: React.FC<any>
    = () => {
        ...
        const onSubmit = async (data: { [x: string]: any }) => {
            var server = {
                individualSupport: {
                    Working: data.individualSupport.Working,
                    dosage: data.individualSupport.dosage,
                    reason: data.individualSupport.reason,
                    sideEffects: data.individualSupport.sideEffects,
                    text: data.individualSupport.text,
                    time: data.individualSupport.time,
                },
            };
                    ...
                    <FormProvider {...methods}>
                        <form onSubmit={methods.handleSubmit(onSubmit)}>
                            <button className="accordion" onClick={headerClicked} type="button">
                                <IonLabel>Individual Support</IonLabel>
                            </button>
                            <div className="panel">
                                <IndividualSupport
