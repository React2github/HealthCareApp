...
import FunctionalForm from "./FunctionalComponents/FunctionalForm";


const FuncInfoForm: React.FC<any>
  = () => {
    ...
    const onSubmit = async (data: { [x: string]: any }) => {
      var server = {
        functionalForm: {
          foodTexture: data.functionalForm.Foodtexture,
          adaptive: data.functionalForm.adaptive,
          cognitive: data.functionalForm.cognitive,
          communication: data.functionalForm.communication,
          equipment: data.functionalForm.equipment,
          intolerance: data.functionalForm.intolerance,
          communicationMethod: data.functionalForm.communicationMethod,
          order: data.functionalForm.order,
        },
      };
          ...
          <FormProvider {...methods}>
            <form onSubmit={methods.handleSubmit(onSubmit)}>
              <button className="accordion" onClick={headerClicked} type="button">
                <IonLabel>Functional Info</IonLabel>
              </button>
              <div className="panel">
                <FunctionalForm
